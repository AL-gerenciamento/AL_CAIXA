...
# Uso: pyinstaller packaging/orvyn.spec  (rodar a partir da raiz do projeto)
#
# Windows/Linux: gera um unico arquivo executavel (dist/ORVYN.exe ou
# dist/ORVYN) - nada de pasta cheia de dlls/arquivos soltos.
# macOS: gera dist/ORVYN.app (bundle nativo, ja aparece como 1 icone so).
